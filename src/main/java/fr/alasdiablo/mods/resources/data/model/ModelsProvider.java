...
public class ModelsProvider extends ModelProvider {
    ...
    protected void registerModels(@NotNull BlockModelGenerators blockModels, @NotNull ItemModelGenerators itemModels) {
        itemModels.generateFlatItem(ExtendedResourcesItems.STEEL_INGOT.get(), ModelTemplates.FLAT_ITEM);
        ...
        itemModels.generateFlatItem(ExtendedResourcesItems.ENRICHED_IRON_DUST.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(ExtendedResourcesItems.STEEL_DUST.get(), ModelTemplates.FLAT_ITEM);
        ...
        itemModels.generateFlatItem(ExtendedResourcesItems.STEEL_NUGGET.get(), ModelTemplates.FLAT_ITEM);
        ...
        itemModels.generateFlatItem(ExtendedResourcesItems.STEEL_PLATE.get(), ModelTemplates.FLAT_ITEM);
        ...
        itemModels.generateFlatItem(ExtendedResourcesItems.STEEL_GEAR.get(), ModelTemplates.FLAT_ITEM);
        ...
        itemModels.generateFlatItem(ExtendedResourcesItems.STEEL_ROD.get(), ModelTemplates.FLAT_ITEM);

        itemModels.generateFlatItem(ExtendedResourcesItems.MORTAR.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(ExtendedResourcesItems.PESTLE.get(), ModelTemplates.FLAT_ITEM);
        ...
        itemModels.generateFlatItem(ExtendedResourcesItems.MORTAR_AND_PESTLE.get(), ModelTemplates.FLAT_ITEM);
    }
}
